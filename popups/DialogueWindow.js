class DialogueWindow extends PopupWindow
{
    ...
    dialogueFont = "14px KanitM";
    nameFont = "12px KanitM";
    ...
    textSounds = [new Media("Shared/Audio/click1.wav"), new Media("Shared/Audio/click2.wav"), new Media("Shared/Audio/click3.wav"), new Media("Shared/Audio/click4.wav"), new Media("Shared/Audio/click5.wav")];
    ...
    constructor(boundingBox)
    {
        ...
        var buttonWidth = this.boundingBox.width * 0.2;
        var buttonHeight = this.boundingBox.width * 0.05
        this.addHitbox(new Button(
            upgradeb, _("Skip"), "9px KanitM", "#000000",
            {
                x: this.frameWidth + this.boundingBox.width * 0.025 - buttonWidth / 2 + this.boundingBox.width * 0.125,
        ...
        this.textX = this.frameWidth + this.boundingBox.width * 0.3;
    ...
    render()
    {
        ...
        var portraitWidth = this.boundingBox.width * 0.25;
        ...
        else if (this.currentDialogue.image)
        {
            drawImageFitInBox(
                this.context,
        ...
        this.context.moveTo(portraitX + portraitWidth + portraitPadding / 2, this.frameHeight);
        this.context.lineTo(portraitX + portraitWidth + portraitPadding / 2, this.boundingBox.height - this.frameHeight);
        this.context.stroke();
    ...
    renderDialogue()
    {
        var speed = this.currentDialogue.speed || this.dialogueSpeed;
        if (this.currentCharIndex < this.currentDialogue.text.length)
        {
            this.currentCharIndex += speed;
