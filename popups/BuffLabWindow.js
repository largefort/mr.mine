class BuffLabWindow extends BottomTabbedPopup
{
    ...
    constructor(boundingBox)
    {
        ...
        this.buffListPane = new Scrollbox(
            ...
            this.bodyContainer.boundingBox.height - this.bodyContainer.boundingBox.height * 0.05,
            this.context,
        ...
        this.buffListPane.isVisible = () => (this.currentTabIndex == 0 && !this.selectedBuffIndex && this.selectedBuffIndex !==  0);
        this.buffListPane.isEnabled = () => (this.currentTabIndex == 0 && !this.selectedBuffIndex && this.selectedBuffIndex !==  0);
        ...
        this.buffCraftingPane.isVisible = () => (this.selectedBuffIndex || this.selectedBuffIndex ===  0);
        this.buffCraftingPane.isEnabled = () => (this.selectedBuffIndex || this.selectedBuffIndex ===  0);
        ...
        this.currentEnergyDisplay.isEnabled = () => this.currentTabIndex == 0;
        this.currentEnergyDisplay.isVisible = () => this.currentTabIndex == 0;
        this.currentEnergyDisplay.allowBubbling = true;
        this.bodyContainer.addHitbox(this.currentEnergyDisplay);
        this.buffCraftingPane.addHitbox(craftButton);
        this.buffCraftingPane.isEnabled = () => false;
        ...
        this.backButton.isVisible = () => (this.selectedBuffIndex || this.selectedBuffIndex ===  0);
        this.backButton.isEnabled = () => (this.selectedBuffIndex || this.selectedBuffIndex ===  0);
        this.bodyContainer.addHitbox(this.backButton);
    }
                ...
                var itemHitbox = new Hitbox(
                    ...
                    },
                    {
                        onmousedown: function (i)
                        {
                            ...
                            this.buffCraftingPane.isEnabled = () => true;
                            this.buffCraftingPane.isVisible = () => true;
                            this.generateMenuContents(this.currentTabIndex, this.buffListPane);
                        }.bind(this, i),
