class PromoPopup extends TabbedPopupWindow
{
    ...
    promoUrl = "https://store.steampowered.com/app/1184820/Poker_Quest/?ref=MrMine";
    promoAsset = activePromoAsset;
    promoText1 = "Check out Poker Quest, currently free in alpha! It's by our publisher, Playsaurus.";
    promoText2 = "A roguelike card game set in a vast world of castles, knights, wizards, and dragons.";
    ...
    constructor(boundingBox)
    {
        ...
        this.addHitbox(new Button(
            JustUpgrade, _("VIEW ON STEAM"), "26px KanitB", "#000000",
            {
