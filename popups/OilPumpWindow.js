class OilPumpWindow extends BottomTabbedPopup
{
    ...
    constructor(boundingBox)
    {
        ...
        this.craftButton = this.bodyContainer.addHitbox(
            new Button(
                startb, _("Upgrade"), fontSize + "px KanitB", "#000000",
                {
                ...
                }, 
                {
                    onmousedown: function()
                    {
                        ...
                        if(craftingWindow)
                        {
                            ...
                            craftingWindow.selectedBlueprint = getBlueprintById(3, 4);
        ...
        this.craftButton.isEnabled = () => oilrigStructure.level < oilrigStructure.maxLevel;
        this.craftButton.isVisible = () => oilrigStructure.level < oilrigStructure.maxLevel;
    }
    ...
    render()
    {
        ...
        this.context.fillText(_("Oil Pump Lvl.{0}", oilrigStructure.level), this.boundingBox.width * .05, this.boundingBox.height * .25);
    }
}
