class OfferChestWindow extends BottomTabbedPopup
{
    ...
    initializeBaseTab()
    {
        ...
        this.compressorPane.basicChestDisplay.render = function (parentWindow)
        {
            ...
            fillTextWrap(
                parentWindow.context,
                "x " + offerManager.getStoredChestsOfType(ChestType.basic),
                coords.x,
        ...
        this.compressorPane.basicChestButton = this.compressorPane.addHitbox(new Button(
            ...
            },
            {
                ...
                {
                    offerManager.grantStoredChest(ChestType.basic);
                }
            }
        ));
        this.compressorPane.basicChestButton.isEnabled = () => offerManager.getStoredChestsOfType(ChestType.basic) > 0;
        ...
        this.compressorPane.goldChestDisplay.render = function (parentWindow)
        {
            ...
            fillTextWrap(
                parentWindow.context,
                "x " + offerManager.getStoredChestsOfType(ChestType.gold),
                coords.x,
                imageBoundingBox.y + imageBoundingBox.height,
                this.boundingBox.width,
                "center"
        ...
        this.compressorPane.goldChestButton = this.compressorPane.addHitbox(new Button(
            ...
            },
            {
                onmousedown: function ()
                {
                    offerManager.grantStoredChest(ChestType.gold);
                }
            }
        ));
        this.compressorPane.goldChestButton.isEnabled = () => offerManager.getStoredChestsOfType(ChestType.gold) > 0;
        ...
        this.compressorPane.blackChestDisplay.render = function (parentWindow)
        {
            ...
            fillTextWrap(
                parentWindow.context,
                "x " + offerManager.getStoredChestsOfType(ChestType.black),
                coords.x,
                imageBoundingBox.y + imageBoundingBox.height,
                this.boundingBox.width,
                "center"
        ...
        this.compressorPane.blackChestButton = this.compressorPane.addHitbox(new Button(
            ...
            },
            {
                onmousedown: function ()
                {
                    offerManager.grantStoredChest(ChestType.black);
                }
            }
        ));
    ...
    render()
    {
        ...
        if(this.currentTabIndex == 0)
        {
            ...
            this.compressorPane.basicChestButton.image = offerManager.getStoredChestsOfType(ChestType.basic) > 0 ? upgradeb : upgradebg_blank;
            this.compressorPane.goldChestButton.image = offerManager.getStoredChestsOfType(ChestType.gold) > 0 ? upgradeb : upgradebg_blank;
            this.compressorPane.blackChestButton.image = offerManager.getStoredChestsOfType(ChestType.black) > 0 ? upgradeb : upgradebg_blank;
        }
