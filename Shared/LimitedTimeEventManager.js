...
class Christmas extends LimitedTimeEvent
{
    ...
    activate(eventManager)
    {
        ...
        assetLoader.loadAsset(
            {
                desktop: "Shared/Assets/Events/Christmas/frame.webp",
                mobile: "Shared/Assets/Events/Christmas/mobile_frame.png"
            },
            "xmasFrame"
        );
        assetLoader.loadAsset({mobile: "Shared/Assets/Events/Christmas/popup_lights.png"}, "xmasPopupLights");
...
class LimitedTimeEventManager
{
    ...
    init()
    {
        ...
        for(var i = 0; i < eventClasses.length; i++)
        {
            ...
            if(i == this.debugForcedEventIndex || (tempEventInstance.isEnabled && tempEventInstance.isActive()))
            {
