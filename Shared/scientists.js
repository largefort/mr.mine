...
var excavationRewards = [
    ...
    {"id": 6, "name": _("2x Tickets"), "description": _("2 Tickets"), "image": ticketicon, "rarity": .62, "isRelic": false, "grantFunction": function () {tickets += 2;}, "isCandidateFunction": alwaysTrue, "relatedIndexesForSacrifice": [], "renderFunction": standardRelicRenderFunction, "hasRewardScaling": false},
        ...
        if(isScientistDead(scientistIndex))
        {
            if(tickets >= costToResurrect)
            {
                ...
                showConfirmationPrompt(
                    ...
                    {
                        hideSimpleInput();
                        trackEvent_SpentTickets(costToResurrect, "RESURRECTED SCIENTIST");
