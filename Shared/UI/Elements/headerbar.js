class HeaderBar extends Hitbox
{
    ...
    setIcon(icon, iconPositionX = -0.025)
    {
        ...
        if (this.relativeIconWidth > this.maxIconWidth)
        {
            this.relativeIconWidth = this.maxIconWidth;
            this.relativeIconHeight = (icon.height * (this.relativeIconWidth * this.boundingBox.width) / icon.width) / this.boundingBox.height;
        }
    }
