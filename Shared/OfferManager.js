class OfferManager
{
    ...
    updateOffer(newOffer)
    {
        ...
        this.lastOfferStartTime = parseInt(newOffer.startTime);
        this.lastOfferEndTime = newOffer.startTime + newOffer.duration;
    ...
    completePurchase()
    {
		...
		if (typeof(appsFlyer) != "undefined")
		{
			appsFlyer.logPurchase(this.currentOffer.sku, transactionCents);
		}
