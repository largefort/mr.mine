...
class BaseShopItem
{
    ...
    onPurchase()
    {
        ...
        trackEvent_SpentTickets(this.getCost(), this.name);
...
{
    categoryType = SHOP_CATEGORIES.CHESTS;
    type;
...
{
    categoryType = SHOP_CATEGORIES.BUFFS;
...
{
    categoryType = SHOP_CATEGORIES.MISC;
    maxQuantity = 5;
...
{
    categoryType = SHOP_CATEGORIES.FREE;
