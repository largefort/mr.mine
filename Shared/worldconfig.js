var worldConfig = {
    sideBoundFraction: 0.09,
    topBoundFraction: 0.12,
    bottomBoundFraction: 0.05,
...
{
    worldConfig.bottomBoundFraction = mobileFooterH / mainh;

    var levelImageWidth = 926;
    var levelImageHeight = 240;
    worldConfig.leftBound = Math.floor(mainw * worldConfig.sideBoundFraction);
    worldConfig.rightBound = Math.ceil(mainw * (1 - worldConfig.sideBoundFraction));
    worldConfig.topBound = Math.floor(mainh * worldConfig.topBoundFraction);
    worldConfig.bottomBound = Math.floor(mainh * (1 - worldConfig.bottomBoundFraction));
    ...
    worldConfig.numberOfDepthsVisible = (mainh * (1 - worldConfig.bottomBoundFraction) - worldConfig.topBound) / worldConfig.levelHeight;
    worldConfig.maxDepthOffset = 1 - (worldConfig.bottomBoundFraction * mainh / worldConfig.levelHeight)
}
...
function initializeLevelHitboxes()
{
    ...
    topCityHitbox.render = function ()
    {
        ...
        {
            if(!this.croppedHeight)
            {
                this.croppedHeight = coords.y;
            }
            var numberOfLightSegments = 6;
            var lightWidth = this.boundingBox.width / numberOfLightSegments;
            var lightHeight = getScaledDimensions(xmasLights.width / 4, xmasLights.height / 3, lightWidth).height;
            for(var i = 0; i < numberOfLightSegments; i++)
            {
                MAIN.drawImage(
                    xmasLights,
                    ((i + Math.floor(numFramesRendered / 4)) % 4) * xmasLights.width / 4,
                    0,
                    xmasLights.width / 4,
                    xmasLights.height / 3,
                    coords.x + (i * lightWidth),
                    coords.y + worldConfig.topBound - this.croppedHeight,
                    lightWidth,
                    lightHeight
                );
            }
        ...
        fillTextWrapWithHeightLimit(
            ...
            coords.y + Math.ceil(this.boundingBox.height * 0.375),
        ...
        fillTextWrapWithHeightLimit(
            ...
            coords.y + Math.ceil(this.boundingBox.height * 0.635),
        ...
        fillTextWrapWithHeightLimit(
            ...
            coords.y + Math.ceil(this.boundingBox.height * 0.5),
        ...
        if(showGarageSparkles && depth > 20)
        {
            ...
            MAIN.drawImage(
                ...
                coords.y + Math.ceil(this.boundingBox.height * 0.51),
    ...
    var sellBuilding = topCityHitbox.addHitbox(new Hitbox(
        {
            x: topCityHitbox.boundingBox.width * 0.13,
            y: topCityHitbox.boundingBox.height * 0.43,
        ...
        function ()
        {
            var showArrow = (getEarth().workersHired == 0 && getValueOfMinerals().greaterThanOrEqualTo(getEarth().workerHireCost())) || // Can hire first worker
                (getBlueprintCount() == 6 && getValueOfMinerals().greaterThanOrEqualTo(150)) ||     // Can craft first blueprint
    ...
    topCityHitbox.addHitbox(new Hitbox(
        {
            ...
            y: topCityHitbox.boundingBox.height * 0.69,
        ...
        function ()
        {
            var showArrow = money.greaterThanOrEqualTo(getEarth().workerHireCost()) && getEarth().workersHired == 0;
    ...
    topCityHitbox.addHitbox(new Hitbox(
        {
            ...
            y: topCityHitbox.boundingBox.height * 0.18,
    ...
    var managerHitbox = topCityHitbox.addHitbox(new Hitbox(
        {
            x: topCityHitbox.boundingBox.width * 0.57,
            y: topCityHitbox.boundingBox.height * 0.43,
    ...
    var chestCollectorHitbox = topCityHitbox.addHitbox(new Hitbox(
        {
            ...
            y: topCityHitbox.boundingBox.height * 0.74,
            width: topCityHitbox.boundingBox.width * 0.27,
    ...
    chestCollectorHitbox.render = function ()
    {
        ...
        if(chestCompressorStructure.level > 0)
        {
            ...
            var compactorImage = window["compactor" + Math.min(5, chestCompressorStructure.level)];
    ...
    var questHitbox = topCityHitbox.addHitbox(new Hitbox(
        {
            ...
            y: topCityHitbox.boundingBox.height * 0.27,
    ...
    topCityHitbox.addHitbox(new Hitbox(
        {
            ...
            y: topCityHitbox.boundingBox.height * 0.5,
            width: topCityHitbox.boundingBox.width * 0.28,
    ...
    titanTopCityHitbox.render = function ()
    {
        ...
        fillTextWrapWithHeightLimit(
            ...
            _("SELL"),
            coords.x + Math.ceil(this.boundingBox.width * 0.15),
            coords.y + Math.floor(this.boundingBox.height * 0.353),
        ...
        fillTextWrapWithHeightLimit(
            MAIN,
            _("HIRE"),
            coords.x + Math.ceil(this.boundingBox.width * 0.33),
            coords.y + Math.ceil(this.boundingBox.height * 0.62),
            Math.ceil(this.boundingBox.width * 0.15),
            Math.ceil(this.boundingBox.height * 0.06),
            "center",
            0.01
        ...
        fillTextWrapWithHeightLimit(
            MAIN,
            _("CRAFT"),
            coords.x + Math.ceil(this.boundingBox.width * 0.73),
            coords.y + Math.ceil(this.boundingBox.height * 0.62),
    ...
    titanTopCityHitbox.addHitbox(new Hitbox(
        {
            x: topCityHitbox.boundingBox.width * 0.30,
            y: topCityHitbox.boundingBox.height * 0.85,
            width: topCityHitbox.boundingBox.width * 0.33,
            height: topCityHitbox.boundingBox.height * 0.27
        },
        {
    ...
    titanTopCityHitbox.addHitbox(new Hitbox(
        {
            x: topCityHitbox.boundingBox.width * 0.67,
            y: topCityHitbox.boundingBox.height * 0.82,
            width: topCityHitbox.boundingBox.width * 0.25,
            height: topCityHitbox.boundingBox.height * 0.26
        },
        {
    ...
    titanTopCityHitbox.addHitbox(new Hitbox(
        {
            x: topCityHitbox.boundingBox.width * 0.66,
            y: topCityHitbox.boundingBox.height * 0.49,
            width: topCityHitbox.boundingBox.width * 0.32,
            height: topCityHitbox.boundingBox.height * 0.23
        },
        {
